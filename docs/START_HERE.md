...
This project adds repository setup files, not application code.

If you are new to GitHub, open source, or AI-assisted coding workflows, this is the first document to read after the README.
