...
6. If `.github/workflows/ci-smoke.yml` exists, note that it can auto-detect npm, pnpm, or yarn starter commands, then edit it so the install, build, and smoke commands match your real app.
